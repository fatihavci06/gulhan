...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h6 class="mb-0 text-uppercase">Video Ekle</h6>
    </div>
    <hr/>
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('admin.videos.index') }}" class="row g-3" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="video_tr" value="{{ old('video_tr') }}" class="form-control @error('video_tr') is-invalid @enderror" id="video_tr">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="video_en" value="{{ old('video_en') }}" class="form-control @error('video_en') is-invalid @enderror" id="video_en">
